...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Dimitri Escapes Prison", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Dimitri Escapes Prison", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "AGGS";
		app.meta["file"] = "Dimitri Escapes Prison";
		app.meta["name"] = "Dimitri Escapes Prison";
		...
		#elseif air
		app.window.title = "Dimitri Escapes Prison";
		#else
